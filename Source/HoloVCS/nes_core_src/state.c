...
SFORMAT SFCPUC[] = {
   { &g_NESX.jammed, 1, "JAMM" },
   { &g_NESX.IRQlow, 4 | RLSB, "IQLB" },
   { &g_NESX.tcount, 4 | RLSB, "ICoa" },
   { &g_NESX.count, 4 | RLSB, "ICou" },
...
void FCEU_DrawSaveStates(uint8 *localXBuf)
{
}
