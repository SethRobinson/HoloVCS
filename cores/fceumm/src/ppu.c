...
//SETH Fill color set here
uint8 gNoBGFillColor = 0x0;
...
static void ResetRL(uint8 *target) {
	...
	Pline = target;
	firsttile = 0;
	linestartts = timestamp * 48 + g_NESX.count;
	tofix = 0;
	FCEUPPU_LineUpdate();
	tofix = 1;
}
